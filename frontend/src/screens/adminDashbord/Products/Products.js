...
import { listProducts, productDelete } from '../../../redux/actions/productAction';
...
const Products = ({ history }) => {
	...
	useEffect(
		...
		[ dispatch, success, createSuccess, createdProduct, userInfo, history, page, limit ]
	);
	...
	const rowData = [ 'Sr No.', 'Id', 'Title', 'Rating', 'Category', 'Price', 'Action' ];
						...
						<TableCell>
							{
								<div>
									...
									<IconButton className={classes.error} onClick={() => deleteHandler(product._id)}>
										<IoMdTrash />
									</IconButton>
								</div>
							}
